...
export default function PropertyDetails(props){
    ...
    const [data,updatedata] = useState({
                                            imgsrc:'',
                                            Location:"01 Prince Consort Road",
                                            LocationSteet:"Kelton,",
                                            ZipCode:"DG1 9UH",
                                            bedroomno:4,
                                            bathroomno:2,
                                            halls:3,
    ...
    return(
        <>
            <div className="LocationCardConatainer mb-2">
                <img  className="ImageContainer" src={'/property.jpg'} alt="img"/>
                <div className="LocationCardInfo">
                    <div className="w-100 d-flex flex-row align-items-center justify-content-center">
                    <div className="TextWrapper w-75">
                        <h1 className="Heading">{props.data.address}</h1>
                        <p className="subHeading">{data.LocationSteet}</p>
                    </div>
                    <div className="w-25 d-flex flex-column justify-content-center align-items-center">
                        <div className="DocumentChip" style={color(props.data.status)}>
                            <p className="DocumentTypeText m-0">{props.data.status}</p>
                        </div>
                    </div>  
                    </div>
                    <div className="HousInfoWrapper">
                        <div className="TextInfoWrapper">
                            ...
                            <p className="ZipcodeVal">{props.data.zip_code}</p>
                        </div>
                        <div className="RoomInfoContainer">
                            <div className="IconWrapper">
                                ...
                                <p className="IconVal">{props.data.bedroom_count}</p>
                            </div>
                            <div className="IconWrapper">
                                <div className="Icon">
                                ...
                                <p className="IconVal">{props.data.bathroom_count}</p>
                            </div>
                            <div className="IconWrapper">
                                <div className="Icon">
                                ...
                                <p className="IconVal">{props.data.livingroom_count}</p>
                            </div>
                        </div>
                    </div>
                </div>
