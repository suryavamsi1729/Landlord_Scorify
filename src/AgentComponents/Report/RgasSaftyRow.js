...
export default function RagsSaftyRow({data}){
        ...
        <tr className="w-100 d-flex flex-row">
            ...
            <td className="RowItm">
                <div className="DocumentChip d-flex  flex-row gap-2" >
                    ...
                    <span className="DocumentId">{` ${data.Document}`}</span>
                </div>
            </td>
            <td className="RowItm">
                <div className="DocumentChip" style={color(data.Result)}>
                    <p className="DocumentTypeText m-0">{data.Result}</p>
                </div>
            </td>
            {/* <td className="RowItm creator d-flex flex-row justify-content-center align-items-center gap-2">
                <img alt="img" className="profileimg" src={img}/>
            ...
            <td className="RowItm">   
                <p className="DateText m-0">{data.ExpiryDate}</p>
            </td>
            
            <td className="RowItm Action d-flex flex-row justify-content-center align-items-center gap-2">
                <svg onClick={() => openInNewTab(data.Documenturl)} className="Icon" width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
