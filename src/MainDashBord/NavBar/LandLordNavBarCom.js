...
export default function LandLordNavBarCom(){
    ...
    useEffect(()=>{
            ...
            if('/dashboard/regularmaintenance'==loc.pathname){
                ...
                navtab.current[7].classList.add('navTabActive');
                setToggleIcon('invite');
                setSideBarT(true);
                    dispatch(
                        {
                ...
                <div className="NavigationBar">
                    ...
                    <div ref={(ele)=>{
                            ...
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.00008 1.29199C13.2567 1.29199 16.7084 4.74283 16.7084 9.00033C16.7084 13.257 13.2567 16.7087 9.00008 16.7087C4.74258 16.7087 1.29175 13.257 1.29175 9.00033C1.29175 4.74283 4.74258 1.29199 9.00008 1.29199Z" stroke="#52525B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8.99601 10.2501V9.24214C8.99601 9.24214 10.6666 9.00006 10.6666 7.33339C10.6666 6.91673 10.242 5.83692 8.99601 5.83691C7.74998 5.83691 7.33331 6.91673 7.33331 7.33339" stroke="#52525B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8.99581 12.1637H9.00415" stroke="#52525B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div ref={(ele)=>{
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10 14.8729C14.6994 14.8729 16.8734 14.27 17.0834 11.8503C17.0834 9.43217 15.5676 9.58766 15.5676 6.62076C15.5676 4.30329 13.371 1.6665 10 1.6665C6.629 1.6665 4.43239 4.30329 4.43239 6.62076C4.43239 9.58766 2.91669 9.43217 2.91669 11.8503C3.12748 14.2792 5.3015 14.8729 10 14.8729Z" stroke="#52525B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M11.9907 17.3809C10.8539 18.6431 9.08058 18.6581 7.93292 17.3809" stroke="#52525B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div ref={(ele)=>{
                            ...
                            <div className="Icon h-100 d-flex flex-column justify-content-center align-items-center">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.8928 15.8914C13.346 18.4385 9.57483 18.9888 6.4887 17.5615C6.03311 17.3781 5.65959 17.2298 5.3045 17.2298C4.31543 17.2357 3.08433 18.1947 2.44449 17.5557C1.80465 16.9157 2.76441 15.6837 2.76441 14.6886C2.76441 14.3335 2.62203 13.9666 2.43862 13.5102C1.01071 10.4245 1.56178 6.65208 4.10857 4.10584C7.35969 0.85353 12.6417 0.853531 15.8928 4.10501C19.1498 7.36234 19.1439 12.6399 15.8928 15.8914Z" stroke="#52525B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M13.2829 10.3439H13.2904" stroke="#52525B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9.94203 10.3439H9.94953" stroke="#52525B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M6.60121 10.3439H6.60871" stroke="#52525B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div ref={(ele)=>{
                            ...
                            <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.9873 11.7881C3.76428 11.7881 1.0119 12.2754 1.0119 14.227C1.0119 16.1786 3.74682 16.6833 6.9873 16.6833C10.2103 16.6833 12.9619 16.1952 12.9619 14.2444C12.9619 12.2936 10.2278 11.7881 6.9873 11.7881Z" stroke="#52525B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.98729 9.00474C9.10236 9.00474 10.8167 7.28966 10.8167 5.17458C10.8167 3.0595 9.10236 1.34521 6.98729 1.34521C4.87221 1.34521 3.15713 3.0595 3.15713 5.17458C3.14998 7.28252 4.85316 8.99759 6.9603 9.00474H6.98729Z" stroke="#52525B" stroke-width="1.42857" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
