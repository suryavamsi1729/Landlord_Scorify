    ...
    return(
        <>
          ...
          <tr key={index} className='w-100 d-flex flex-row'>
            ...
            <td className='datacol'>{item.current_eer}</td>
            <td className='datacol'>{item.potential_eer}</td>
            <td className='datacol d-flex flex-row justify-content-center gap-2'>
            <a href={item.view_document} target="_blank" rel="noopener noreferrer">
            <svg
              className="Icon"
              width="18"
              height="15"
          ...
          <a href={item.download_document} download>
            <svg
              width="20"
              height="21"
              viewBox="0 0 20 21"
